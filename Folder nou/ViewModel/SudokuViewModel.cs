...
namespace SudokuMaker.ViewModel
{
    public class SudokuViewModel: INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Comanda actuală de salvare a jocului
        /// În prezent aruncă o excepție, blestemând imposibilitatea serializării structurii de grosime.
        /// Trebuie îmbunătățită funcționalitatea încărcării / salvării.
        /// </summary>
